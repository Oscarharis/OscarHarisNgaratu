...
public class App {
    ...
    public static void main(String[] args) {
        ...
        kodeMatkul.add("PS0101");
        namaMatkul.add("nilai dasar shalih akram");
        sksMatkul.add(2);
        nilaiMatkul.add("B");
        kodeMatkul.add("PS0102");
        namaMatkul.add("Teknologi Aswaja");
        sksMatkul.add(2);
        nilaiMatkul.add("A-");
        kodeMatkul.add("PS0104");
        namaMatkul.add("Civic education");
        sksMatkul.add(2);
        nilaiMatkul.add("A-");
        kodeMatkul.add("PS0201");
        namaMatkul.add("Ulumul Quran");
        sksMatkul.add(2);
        nilaiMatkul.add("A-");
        kodeMatkul.add("PS0203");
        namaMatkul.add("Sejarah pemikiran dan keuangan perbankan");
        sksMatkul.add(2);
        nilaiMatkul.add("B+");
        kodeMatkul.add("PS0205");
        namaMatkul.add("Bahasa Arab I");
        sksMatkul.add(2);
        nilaiMatkul.add("B-");
        kodeMatkul.add("PS0207");
        namaMatkul.add("Bahasa Inggris I");
        sksMatkul.add(2);
        nilaiMatkul.add("B");
        kodeMatkul.add("PS0209");
        namaMatkul.add("Pengantar ekonomi mikro");
        sksMatkul.add(3);
        nilaiMatkul.add("A-");
        kodeMatkul.add("PS0218");
        namaMatkul.add("Manajemen Syariah");
        sksMatkul.add(2);
        nilaiMatkul.add("A-");
        kodeMatkul.add("PS0227");
        namaMatkul.add("Pengantar Filsafat");
        sksMatkul.add(2);
        nilaiMatkul.add("A-");
        kodeMatkul.add("PS0416");
        namaMatkul.add("Bahasa Indonesia");
        sksMatkul.add(2);
        nilaiMatkul.add("A-");
        try (Scanner input = new Scanner(System.in)) {
            ...
            for (int i = 0; i < kodeMatkul.size(); i++) {
                if (semester >= (i + 1)) {
                    ...
                    System.out.println(
                            (i + 1) + "   | " + kode + " | " + Matkul + " | " + sks + " | " + nilai + " | " + bobot);
